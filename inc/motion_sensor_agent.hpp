#ifndef MOTION_SENSOR_AGENT_HPP
#define MOTION_SENSOR_AGENT_HPP
...
class MotionSensorAgent : public device::AbstractAgent {
public:
    explicit MotionSensorAgent(device::DeviceDetails& a_device);    
